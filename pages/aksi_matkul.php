...
<body>
    ...
    <div class="navbar">
        ...
        <div class="rightNav">
            ...
            <p>
                <a href="./lihatData.php" class="goTo">DATA</a>
            </p>
        </div>
    </div>
    ...
    $sql = "INSERT INTO matkul (kode_matkul, nama_matkul, sks, semester, dosen, kategori, deskripsi) VALUES ('$kode_matkul', '$nama_matkul', '$sks', '$semester', '$dosen', '$kategori', '$deskripsi')";
